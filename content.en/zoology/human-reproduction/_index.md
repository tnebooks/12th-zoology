...
![Fig. 2.2 (a) Diagrammatic view of the male reproductive system](2.2.png "")


![Fig. 2.2 (b) Testis showing inner details](2.3.png "")
...
![Fig. 2.3 (a) Female pelvis showing reproductive system](2.4.png "")
...
The fallopian tubes (uterine tubes or oviducts), uterus and vagina constitute the female accessory organs **(Fig. 2.3 b)**. Each fallopian tube extends from the periphery of each ovary to the uterus. The proximal part of the fallopian tube bears a funnel shaped **infundibulum**. The edges of the infundibulum have many finger like projections called **fimbriae** which help in collection of the ovum after ovulation.

![Fig. 2.3 (b) Diagrammatic view of female reproductive system](2.5.png "")
